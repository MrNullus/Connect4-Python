...
# @Variablesfor ROW and COLUMN game
ROW_COUNT = 6
COLUMN_COUNT = 7
            ...
            if turn == 0:
                ...
                if is_valid_location(board, col):
                    ...
                    if winning_move(board, 1):
                        label = myfont.render("PLAYER 1 WINS !!!! Toasty!!", 1, RED)
            ...
            # Ask for Player 2 Input
                ...
                if is_valid_location(board, col):
                    ...
                    if winning_move(board, 2):
                        label = myfont.render("PLAYER 2 WINS !!!! Toasty!!", 1, YELLOW)
                        screen.blit(label, (40, 10))
